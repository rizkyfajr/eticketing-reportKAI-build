...
<template>
    <DashboardLayout :title="__('Terkirim')">
        <div
        ...
        <main class="p-0 py-0 mb-[1.25rem] ml-[1.25rem] mt-[1.25rem]">
            <h2 class="font-bold text-2xl">Laporan Terkirim</h2>
        ...
        <Card class="flex flex-col rounded-lg bg-white pt-[1.875rem] pb-[2.5rem] shadow-lg border border-solid border-slate-200" style="border-radius: 0.625rem;">
        <template #header>
        ...
        <form
            ...
            class="w-full max-w-7xl h-fit shadow-xl bg-black" 
        >
